...
<html>
  ...
  <body>
    <div class="mainBorder">
      <div class="header">
	  <h1>Välkommen till Student Start Up</h1>       
      </div>
      ...
      <div class="register">
        <fieldset>
          ...
          <form id="postFrame" onsubmit="return validate()" name="registerForm" method="POST" action="register-process.php">
            ...
            <input type="password" id="reglösenord" name="reglosenord" placeholder="Välj lösenord"></textarea><br><br>

            <input type="password" id="valLösen" name="valLosen" placeholder="Upprepa lösenord"></textarea><br>
